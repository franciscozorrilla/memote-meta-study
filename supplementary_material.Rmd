...
dplyr::tibble(
  collection = factor(
    c("agora", "carveme", "path", "kbase", "bigg", "ebrahim", "metagem_gut","metagem_tara","optflux"),
    levels = c("agora", "carveme", "path", "kbase", "bigg", "ebrahim", "metagem_gut","metagem_tara","optflux")
  ),
  name = c(
    "AGORA",
    "CarveMe",
