...
```{r}
colsCollection=c("#A6A9AA","#000000","#3E7CBC","#F29FA9","#A3D2E2","#7E8082","#EDA85F","#CD2028") #labels=c('agora','bigg','ebrahim','metagem','embl','path','seed','uminho')
```
...
levels(model$classes) <-c('AGORA','CarveMe','Path2Models','KBase','BiGG','Ebrahim et al.','metaGEM','OptFlux')
...
plot.rf.var.importance.by.class.andMean.dotplot(model,'test','collection',colorVec=c(colsCollection,'#60d660'),nBestFeatures=15,classNames=c('AGORA','CarveMe','Path2Models','KBase','BiGG','Ebrahim et al.','metaGEM','OptFlux'))
```
...
is_x <- grepl("metagem", rownames(df.num))
collect_type[is_x] <- "metagem"
